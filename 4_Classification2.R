...
#3. updated_clinical_model_mortality_norm.csv
#4. updated_clinical_model_mortality_wTrajectory_norm.csv
...
#feature file list
feature_file_list <- c("Mortality_selected_features_norm.csv",
                       "SOFA_SUM_norm.csv",
                       "APACHE_SUM_norm.csv",
...
#3."max_kdigo_d03_norm.csv",
#4."updated_clinical_model_make_norm.csv"
#5."updated_clinical_model_make_wTrajectory_norm.csv"
####################################################################################### 
#User input
data_dir <- "/Volumes/LJL_ExtPro/Data/AKI_Data/Taylors_Data/TAKI_Feature/Updated_features/"
#data dir 
...
feature_file_list <- c("MAKE_selected_features_norm_option1_withPH.csv.csv",
                       ...
                       "max_kdigo_d03_norm.csv",
                       "updated_clinical_model_make_norm.csv","updated_clinical_model_make_wTrajectory_norm.csv")
