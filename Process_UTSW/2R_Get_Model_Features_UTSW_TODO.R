...
#'@TODO
#Race: need to know white =0 , black =1 , and other = 2, now I only have black vs non-black
# I am guessing 4 is white, 9 is others
#4. Xilong's feature (Load not imputed data)
...
for (i in 1:length(analysis_ID)){
  ...
  Feature_df[i,"RACE"] <- get_feature_forPt(curr_id,All_Demo_df,"Race_Black")
  Feature_df[i,"GENDER"] <- get_feature_forPt(curr_id,All_Demo_df,"Gender_Male")
